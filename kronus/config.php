...
define ('API_KEY', '2F1B42CFCAE0A920E6293AED04EE4F54');
// player's account_id you want to parse
define ('ACCOUNT_ID', 76561198067833250);
...
class config {
    ...
    private static $_data = array(
        'db_user' => '045230160_user',
        'db_pass' => 'pubtest_pass',
        'db_host' => 'localhost',
        'db_name' => 'brainshake2_pubtest',
        'db_table_prefix' => ''
    );
